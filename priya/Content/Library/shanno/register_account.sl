...
operation:
  ...
  inputs:
    ...
    - email
  sequential_action:
    gav: 'com.microfocus.seq:shanno.register_account:1.0.0'
    skills:
      - Java
      - Web
    settings:
    ...
    steps:
      ...
      - step:
          id: '17'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").Link("Sign out")'
          action: Click
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: 'Tuesday, December 24, 2019 4:21:45 AM'
                ...
                - object:
                    ...
                    properties:
                      ...
                      - property:
                          value:
                            value: jamesh My account My orders Sign out
                            regular_expression: false
                          name: text
                          hidden: false
                          read_only: false
