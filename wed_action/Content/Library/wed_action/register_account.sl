...
operation:
  ...
  inputs:
    ...
    - email
  sequential_action:
    gav: 'com.microfocus.seq:wed_action.register_account:1.0.0'
    skills:
      - Web
    settings:
      windows:
    ...
    steps:
      ...
      - step:
          id: '3'
          object_path: 'Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Username")'
          action: Click
          ...
          - object:
              ...
              child_objects:
                - object:
                    ...
                    class: WebElement
                    visual_relations: ''
                    last_update_time: 'Thursday, January 21, 2021 5:37:32 AM'
